...
public class Menu {
	public void render() {
		...
		SteveDriver.gui.drawText("This is the menu. Hit 2 to continue the game, yeah.", -300, 70, Color.BLACK);
		SteveDriver.gui.drawText("Hit 3 to start a new game.", -200, 0, Color.BLACK);
